![MonoCloud Banner](https://raw.githubusercontent.com/monocloud/monocloud-cedar-dotnet/refs/heads/main/banner.svg)
...
[MonoCloud](https://www.monocloud.com?utm_source=nuget&utm_medium=cedar_dotnet) is a modern, developer-friendly Identity & Access Management platform.
...
> [!NOTE]
> This project is a fork of [`cedar-policy/cedar-java`](https://github.com/cedar-policy/cedar-java) — the official Java bindings published by the Cedar Contributors. The .NET surface, type names, and serialization shape mirror the Java SDK closely. See the **Acknowledgments** section below.
...
- **MonoCloud docs:** [https://www.monocloud.com/docs](https://www.monocloud.com/docs?utm_source=nuget&utm_medium=cedar_dotnet)
...
Do **not** report security issues publicly. Please follow the contact instructions at: [https://www.monocloud.com/contact](https://www.monocloud.com/contact?utm_source=nuget&utm_medium=cedar_dotnet)
...
Licensed under the **Apache License, Version 2.0**. See the included [`LICENSE`](https://github.com/monocloud/monocloud-cedar-dotnet/blob/main/LICENSE) file.
